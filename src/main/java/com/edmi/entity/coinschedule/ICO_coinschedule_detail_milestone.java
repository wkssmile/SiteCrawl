...
/**
 * ico_coinschedule_detail_milestone 模型
 */
@Entity
@Table(name = "ico_coinschedule_detail_milestone")
public class ICO_coinschedule_detail_milestone {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long pk_id;

    @Column(nullable = false, name = "milestone_key")
    private String milestone_key;

    @Column(nullable = false, name = "milestone_value")
    private String milestone_value;
    ...
    public String getMilestone_key() {
        return milestone_key;
    }

    public void setMilestone_key(String milestone_key) {
        this.milestone_key = milestone_key;
    }

    public String getMilestone_value() {
