...
@Entity
public class ICO_Etherscan_IO_Blocks_Txs {
    @Id
    ...
    private ICO_Etherscan_IO_Blocks_Txs_Page_List page_list;

    @OneToOne(mappedBy = "txs",cascade = CascadeType.ALL,fetch = FetchType.LAZY)
    private ICO_Etherscan_IO_Blocks_Txs_Info txs_info;
    ...
    public ICO_Etherscan_IO_Blocks_Txs_Page_List getPage_list() {
        return page_list;
    }

    public void setPage_list(ICO_Etherscan_IO_Blocks_Txs_Page_List page_list) {
        this.page_list = page_list;
    }

    public ICO_Etherscan_IO_Blocks_Txs_Info getTxs_info() {
        return txs_info;
    }

    public void setTxs_info(ICO_Etherscan_IO_Blocks_Txs_Info txs_info) {
