...
@Entity
public class ICO_Etherscan_IO_Blocks_Forked {
    ...
    private ICO_Etherscan_IO_Blocks_Forked_Info blocks_info;

    @OneToMany(mappedBy="blocks")
    private List<ICO_Etherscan_IO_Blocks_Forked_Txs_Page_List> pages;
    ...
    public ICO_Etherscan_IO_Blocks_Forked_Info getBlocks_info() {
        return blocks_info;
    }

    public void setBlocks_info(ICO_Etherscan_IO_Blocks_Forked_Info blocks_info) {
        this.blocks_info = blocks_info;
    }

    public List<ICO_Etherscan_IO_Blocks_Forked_Txs_Page_List> getPages() {
        return pages;
    }

    public void setPages(List<ICO_Etherscan_IO_Blocks_Forked_Txs_Page_List> pages) {
        this.pages = pages;
    }
}
