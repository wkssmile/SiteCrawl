...
@Entity
public class ICO_Etherscan_IO_Blocks_Forked_Txs_Info {
    ...
    private ICO_Etherscan_IO_Blocks_Forked_Txs txs;
    ...
    public ICO_Etherscan_IO_Blocks_Forked_Txs getTxs() {
        return txs;
    }

    public void setTxs(ICO_Etherscan_IO_Blocks_Forked_Txs txs) {
        this.txs = txs;
    }
